...
stage3="$(wget -qO- 'http://distfiles.gentoo.org/releases/arm/autobuilds/latest-stage3-armv7a_hardfp.txt' | tail -n1 | awk '{print $1}')"
...
( set -x; cat "$name" | docker import - "$image" )
